...
#   c) node1 mines 32 blocks, so now node 0 has 60001dcw, node 1 has 4250dcw, node2 has none.
#   d) node0 sends 601 dcw to node2, in two transactions (301 dcw, then 300 dcw).
