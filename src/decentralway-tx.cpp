...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Decentralway Core decentralway-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  decentralway-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded decentralway transaction") + "\n" +
                               "  decentralway-tx [options] -create [commands]   " + _("Create hex-encoded decentralway transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded decentralway transaction
