...
#ifndef Decentralway_STAKEINPUT_H
#define Decentralway_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZDCW() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zDCWStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zdcw, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZDCW() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZDCW() override { return false; }
};


#endif //Decentralway_STAKEINPUT_H
