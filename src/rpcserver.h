...
/**
 * Decentralway RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzdcwseed(const UniValue& params, bool fHelp);
extern UniValue getzdcwseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdcw(const UniValue& params, bool fHelp);
extern UniValue dzdcwstate(const UniValue& params, bool fHelp);
