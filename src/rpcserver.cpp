...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Decentralway server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Decentralway server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Decentralway features */
        {"decentralway", "masternode", &masternode, true, true, false},
        {"decentralway", "listmasternodes", &listmasternodes, true, true, false},
        {"decentralway", "getmasternodecount", &getmasternodecount, true, true, false},
        {"decentralway", "masternodeconnect", &masternodeconnect, true, true, false},
        {"decentralway", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"decentralway", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"decentralway", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"decentralway", "masternodecurrent", &masternodecurrent, true, true, false},
        {"decentralway", "masternodedebug", &masternodedebug, true, true, false},
        {"decentralway", "startmasternode", &startmasternode, true, true, false},
        {"decentralway", "createmasternodekey", &createmasternodekey, true, true, false},
        {"decentralway", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"decentralway", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"decentralway", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"decentralway", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"decentralway", "getmasternodescores", &getmasternodescores, true, true, false},
        {"decentralway", "mnbudget", &mnbudget, true, true, false},
        {"decentralway", "preparebudget", &preparebudget, true, true, false},
        {"decentralway", "submitbudget", &submitbudget, true, true, false},
        {"decentralway", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"decentralway", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"decentralway", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"decentralway", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"decentralway", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"decentralway", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"decentralway", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"decentralway", "checkbudgets", &checkbudgets, true, true, false},
        {"decentralway", "mnsync", &mnsync, true, true, false},
        {"decentralway", "spork", &spork, true, true, false},
        {"decentralway", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdcwseed", &getzdcwseed, false, false, true},
        {"zerocoin", "setzdcwseed", &setzdcwseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdcw", &searchdzdcw, false, false, true},
        {"zerocoin", "dzdcwstate", &dzdcwstate, false, false, true}
...
{
    return "> decentralway-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6693/\n";
}
