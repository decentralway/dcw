/* src/config/decentralway-config.h.  Generated from decentralway-config.h.in by configure.  */
/* src/config/decentralway-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.decentralway.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Decentralway Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Decentralway Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "decentralway"
