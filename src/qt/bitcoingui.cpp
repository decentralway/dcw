                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Decentralway Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Decentralway address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and decentralway: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDCW"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Decentralway Core"), this);
    aboutAction->setStatusTip(tr("Show information about Decentralway Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Decentralway"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Decentralway addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Decentralway addresses"));
    ...
    openAction->setStatusTip(tr("Open a Decentralway: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Decentralway Core help message to get a list with possible Decentralway command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Decentralway Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Decentralway network", "", count));
}
...
{
    QString strTitle = tr("Decentralway Core"); // default title
