                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDCWPathCustom = GetArg("-zdcwbackuppath", "");
    ...
    if(!strzDCWPathCustom.empty()) {
        ui->wallet_customzdcwbackuppath->setText(QString::fromStdString(strzDCWPathCustom));
        ui->wallet_customzdcwbackuppath_label->setVisible(true);
        ui->wallet_customzdcwbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDCWPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Decentralway RPC console.") + "<br>" +
