...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Decentralway Core"),
     ...
     * override -datadir in the decentralway.conf file in the default data directory
     * (to be consistent with decentralwayd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
