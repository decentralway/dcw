...
/** Utility functions used by the Decentralway Qt UI.
 */
namespace GUIUtil
{
...
// Render Decentralway addresses in monospace font
...
// Parse "decentralway:" URI into recipient object, return true on successful parsing
