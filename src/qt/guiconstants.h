...
/* Decentralway GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Decentralway"
#define QAPP_ORG_DOMAIN "decentralway.org"
#define QAPP_APP_NAME_DEFAULT "Decentralway-Qt"
#define QAPP_APP_NAME_TESTNET "Decentralway-Qt-testnet"
