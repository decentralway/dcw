Contributing to Decentralway Core
============================

The Decentralway Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Decentralway Core project, and is not to be
confused with overall Decentralway Network Protocol consensus changes.

Whether a pull request is merged into Decentralway Core rests with the project merge
...
Patches that change Decentralway consensus rules are considerably more involved than
...
Where a patch set proposes to change the Decentralway consensus, it must have been
...
The project leader is the release manager for each Decentralway Core release.
