...
In order to support loading of multiple wallets in decentralway-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is decentralway.cpp.
...
Changes to decentralway.cpp
----------------------
decentralway.cpp is the entry point into decentralway-qt, and as such, will require some minor modifications to provide hooks for
